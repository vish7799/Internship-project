		...
		<div class="col-md-qw md-margin-bottom-50">
			<div class="row">
				...
				<div class="col-md-4 col-xs-6 padding_left_right" >
					<form action="<?php echo site_url(); ?>search" method="post" id="sky-form3" class="sky-form sky-changes-3" novalidate="novalidate" style="border: 0px;">
			...
			<div class="row">
					...
					<div class="col-md-4 col-xs-6" style="padding-bottom: 30px;">
						...
						<div class="package_item">
							<div class="news-v2-badge">
								<img src="<?php echo site_url()?>assets/timthumb.php?src=<?php echo site_url()?>assets/photo/product/<?php echo $product->image;?>&w=1000&h=600&zc=1&q=90" alt="">
							</div>
				...
				<div class="col-md-3">
					<?php $this->load->view('right_search.php'); ?>
				</div>
			</div>
		</div>
	</div>
