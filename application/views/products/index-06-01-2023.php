...
<form name="f1" class="sky-form sky-changes-3 product-quantity sm-margin-bottom-20" method="post" action="<?php echo site_url();?>products/add_to_cart" style="width: 100%;">
		<div class="container" style="padding-top:40px; padding-bottom: 10px; width: 95%; ">
			<div class="row">
				<div class="col-md-5">
				...
				<div class="col-md-7 product_box_custom">
					...
					<h3 class="shop-product-title" style="padding-top: 70px; font-weight: bold;">Product Main Description</h3>
					<?php echo $products->description; ?><br>
