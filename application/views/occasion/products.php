			...
			<div class="col-md-qw md-margin-bottom-50">
				<div class="row">
					<div class="col-md-8" >
						...
						<?php 
						if($cat_slug == 'everyday_wear'){
							$title_name		=	'Everyday Wear';
						}elseif($cat_slug == 'office_wear'){
							$title_name		=	'Office Wear';
						}elseif($cat_slug == 'party_wear'){
							$title_name		=	'Party Wear';
						}
						echo $title_name; ?>
						</h1>
					</div>
					<div class="col-md-4 padding_left_right" >
						<form action="<?php echo site_url(); ?>occasion/<?php echo $cat_slug; ?>" method="post" id="sky-form3" class="sky-form sky-changes-3" novalidate="novalidate" style="border: 0px;">
				...
				<div class="item col-md-3" style="padding-bottom: 30px; ">
					<a href="<?php echo site_url(); ?>products/<?php echo $product->slug; ?>">
						<div class="product_box" >
							...
							<p style="font-size: 18px; line-height: 20px; font-weight: bold; color: #000;  padding-left: 10px;">
